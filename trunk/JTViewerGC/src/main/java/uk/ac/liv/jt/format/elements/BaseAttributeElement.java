...
/**
 * Base for all the attribute types, that are not strictly defined as nodes.
 * The attributes for consist for example of the transformation and Material attributes.
 * @author fabio
 *
 */
